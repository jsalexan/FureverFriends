const newFormHandler = async (event) => {
  ...
  switch (avatar) {
    case "optionOne":
      avatar =
      "//res.cloudinary.com/dlxjksvbc/image/upload/v1694814666/dog2_cwiskm.png";
      break;
    case "optionTwo":
      avatar =
        "//res.cloudinary.com/dlxjksvbc/image/upload/v1694814666/dog3_ad2syv.png";
      break;
    case "optionThree":
      avatar =
        "//res.cloudinary.com/dlxjksvbc/image/upload/v1694814665/dog4_u4kbfh.png";
      break;
    case "optionFour":
      avatar =
        "//res.cloudinary.com/dlxjksvbc/image/upload/v1694814662/dog11_qofpmb.png";
      break;
    case "optionFive":
      avatar =
        "//res.cloudinary.com/dlxjksvbc/image/upload/v1694814664/dog6_edn6fq.png";
      break;
    case "optionSix":
      avatar =
        "//res.cloudinary.com/dlxjksvbc/image/upload/v1694814663/dog9_uu5flo.png";
      break;
    case "optionSeven":
      avatar =
        "//res.cloudinary.com/dlxjksvbc/image/upload/v1694814663/dog8_uh9xlw.png";
      break;
    case "optionEight":
      avatar =
        "//res.cloudinary.com/dlxjksvbc/image/upload/v1694814662/dog12_bbhlea.png";
      break;
  }
